...
public class Suporte extends Inimigo {
    ...
    public Suporte(Chefe chefe, Sprite sprite, Vector2 position, Vector2 hitbox, float vida, float velocidadeRotacao, Sprite[] destruicao, float atrito, float aceleracao, float velocidadeMaxima) {
