...
public class CriadorArmas {
    ...
    public static Arma basica(Nave nave, Array<Entidade> projeteis, int multiplicador) {
        return new Arma(nave, projeteis, 0.65f, 5 * (1 + 0.01f * multiplicador), 110, new Vector2(0, 0), BASICA_PROJETIL_SPRITES, new Vector2(8, 8), null);
    }

    public static Arma armaOnda(Nave nave, Array<Entidade> projeteis, int multiplicador) {
        return new Arma(nave, projeteis, 1f, 12 + (7 * multiplicador), 100 + (5 * multiplicador), new Vector2(0, 0), ARMA_ONDA_PROJETIL_SPRITES, new Vector2(32, 32), ARMA_ONDA_SOM);
    }
